...
func TestRule_whomBe(t *testing.T) {
	...
	positive(t, "Whomever have", "[Whoever has]")
	...
	positive(t, "Whomever have a", "[Whoever has] a")
	...
	positive(t, "whomever has went", "[whoever] has [gone]")
	positive(t, "whomever has went there", "[whoever] has [gone] there")
	positive(t, "whomever had went", "[whoever] had [gone]")
	positive(t, "whomever had went there", "[whoever] had [gone] there")
	...
	positive(t, "whomsoever have went", "[whosoever has gone]")
	positive(t, "whomsoever have went there", "[whosoever has gone] there")
